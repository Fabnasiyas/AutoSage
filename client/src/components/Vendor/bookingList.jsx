...
//   return (
//     <div className="relative overflow-x-auto" style={{ paddingTop: '100px', paddingRight: '100px' }}>
//       <h1 className='text-center font-bold text-3xl mb-3'>Booking List</h1>
...
const BookingList = () => {
  ...
  const generateCSVData = () => {
    ...
    const salesSummaryData = [
      ['Total Cars', 'Total Bookings', 'Total Revenue'],
      [totalCars, totalBookings, totalRevenue],
    ];

    const bookingsData = [
      ['Booking Date', 'Total Amount', 'Payment Type', 'Status'],
      ...booking.map((bookingItem) => [
        formatDate(bookingItem.bookingDate),
        bookingItem.totalAmount,
        bookingItem.paymentType,
        isReturned(bookingItem.dropoffDate) ? 'Returned' : 'On Rent',
      ]),
    ];

    return { salesSummaryData, bookingsData };
  };
  ...
  return (
    <div className="relative overflow-x-auto" style={{ paddingTop: '100px', paddingRight: '100px' }}>
      ...
      <div className="flex justify-end mb-7">
        ...
        <CSVLink data={generateCSVData().salesSummaryData} headers={[]} filename="sales_summary.csv">
          <button className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded ml-2">
            Download Sales Summary CSV
          </button>
        </CSVLink>

        <CSVLink data={generateCSVData().bookingsData} headers={[]} filename="bookings.csv">
          <button className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded ml-2">
...
//     const salesReportData = calculateSalesReportData(booking);
//     const { totalCars, totalBookings, totalRevenue } = salesReportData;
//     const csvData = `Total Cars,Total Bookings,Total Revenue\n${totalCars},${totalBookings},${totalRevenue}`;
