...
//         <div className="text-center md:flex-1 mb-2">
...
//       <div className="flex flex-col md:flex-row justify-between pt-4 bg-blue-900 ">
...
//         </div>
//       </div>
//       <div className="text-center  border bg-blue-900">
//         <p className="font-bold text-white mt-5 mb-5">
